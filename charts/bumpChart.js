(function(){
	...
	var chart = raw.chart()
		...
		.description("For continuous data such as time series, a bump chart can be used in place of stacked bars. Based on New York Times's <a href='http://www.nytimes.com/interactive/2014/08/13/upshot/where-people-in-each-state-were-born.html'>interactive visualization.</a>")
...
//			;
		...
		if (showLabels()) {
			...
			function textpathName(d, i) {return 'path-' + i;}
			function textpathHref(d, i) {return '#' + textpathName(d,i);}
